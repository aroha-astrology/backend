 ...
 */
function getPlanetSign(chartData, planet) {
 ...
 */
function backwardDistance(from, to) {
 ...
 */
function jaiminiSignLord(sign, chartData) {
    if (sign === 'Scorpio') {
 ...
 */
function charaDashaDuration(sign, chartData) {
 ...
 */
function charaDashaSignSequence(ascendantSign) {
...
function calculateCharaDasha(ascendantSign, chartData) {
    ...
    const durations = signSequence.map((sign) => charaDashaDuration(sign, chartData));
