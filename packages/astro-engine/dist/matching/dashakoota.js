...
function calculateDina(nakshatraIndex1, nakshatraIndex2) {
...
function calculateMahendra(nakshatraIndex1, nakshatraIndex2) {
...
function calculateStreeDeergha(nakshatraIndex1, nakshatraIndex2) {
...
function calculateRashi(moonSign1, moonSign2) {
...
function calculateVasya(moonSign1, moonSign2) {
...
function calculateRajju(nakshatraIndex1, nakshatraIndex2) {
...
function calculateVedha(nakshatraIndex1, nakshatraIndex2) {
    let hasVedha = false;
    for (const [a, b] of VEDHA_PAIRS) {
        if (a === b)
            continue; // skip self-pair placeholder
        if ((nakshatraIndex1 === a && nakshatraIndex2 === b) ||
...
// =============================================================================
function overallCompatibility(total, max) {
...
//# sourceMappingURL=dashakoota.js.map