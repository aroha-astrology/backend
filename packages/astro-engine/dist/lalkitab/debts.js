 ...
 */
function isPlanetAfflicted(planet, chartData, housesToCheck) {
    ...
    if (planetPos.isRetrograde && planet !== 'Rahu' && planet !== 'Ketu')
        return true;
    ...
    for (const mp of chartData.planets) {
        ...
        if (aspectHouses.includes(planetPos.house))
            return true;
    }
    return false;
}
 ...
 */
function getAspectHouses(planet, fromHouse) {
    const aspects = [];
 ...
 */
function isPlanetInHouses(planet, chartData, houses) {
