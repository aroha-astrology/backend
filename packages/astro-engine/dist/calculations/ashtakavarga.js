 ...
 */
function getPlanetSignIndex(chartData, planet) {
 ...
 */
function getAscSignIndex(chartData) {
 ...
 */
function houseToSignIndex(startSignIndex, houseOffset) {
