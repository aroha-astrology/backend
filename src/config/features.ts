...
export const FEATURE_REGISTRY: readonly FeatureDef[] = [
  ...
  // paid
  { key: 'paid.chat', label: 'AI Chat', group: 'paid', defaultEnabled: true, defaultPricePaise: 2000 },
  {
  ...
  { key: 'paid.vastu', label: 'Vastu Report', group: 'paid', defaultEnabled: true, defaultPricePaise: 5000 },
  {
    key: 'paid.gemstone',
