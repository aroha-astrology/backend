 ...
 * kundli (or, for the current-transit lines, a fresh planet-position
 * calculation) — nothing here is generated by an LLM.
 */
export async function buildGroundingFacts(src: GroundingSource): Promise<string[]> {
  ...
  // --- Current transits (timing signals, not persona-gated) ----------------
